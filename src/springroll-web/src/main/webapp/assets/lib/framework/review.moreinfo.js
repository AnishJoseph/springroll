...
var MoreInfoTableView = Marionette.View.extend({
    ...
    template: _.template('<thead> <tr> <th><%-Localize("ui.review.breachedRuleName")%></th> <th><%-Localize("ui.review.breachedRuleText")%></th> </tr> </thead> <tbody></tbody>'),
...
Application.ReviewMoreInfoTableView = Marionette.View.extend({
    tagName: 'div',
    template: _.template('<div id="prevreviews"></div><h4><%-Localize("ui.review.breachedRules")%></h4><div id="breaches"></div>'),
...
var PreviousReviewersHeader = Marionette.View.extend({
    tagName: 'div',
    template: _.template('<h4 id="previousReviewers"><%-Localize("ui.review.previousReviewers")%></h4>'),
...
var PreviousReviewers = Marionette.View.extend({
    tagName: 'table',
    className: 'table table-hover table-striped ',
    template: _.template('<thead> <tr> <th><%-Localize("ui.review.reviewer")%></th> <th><%-Localize("ui.review.comments")%></th><th><%-Localize("ui.review.time")%></th> </tr> </thead> <tbody></tbody>'),
