...
@Service public class MdmManager extends SpringrollEndPoint {
    ...
    public void on(MdmEvent mdmEvent) {
        ...
        try {
            ...
            logger.debug("{} row(s) updated and {} row(s) created in Master {} via MDM by {}", rowsChanged,mdmDTO.getNewRecords().size(), mdmDTO.getMaster(), SpringrollSecurity.getUser().getUsername());
        }catch (Exception e){
            e.printStackTrace();
        }
    }
