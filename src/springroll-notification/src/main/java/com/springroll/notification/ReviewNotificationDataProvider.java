 ...
 */
@Component public class ReviewNotificationDataProvider implements INotificationDataProvider {
    ...
    public List<? extends INotificationPayload> getPendingNotifications(INotificationChannel notificationChannel) {
        ...
        List<Notification> notifications = repositories.notification.findNotificationsForUser(notificationChannel.getChannelName(),
                springrollUser.getUsername(), springrollUser.getGroups());
