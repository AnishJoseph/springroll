...
@NamedQueries({
        ...
        @NamedQuery(name="UserDelegation.getRecordsForMdm",
                query = "SELECT o.id, o.userId, o.delegate, o.startDate, o.endDate, o.description, o.active FROM UserDelegation o where o.id not  in :idsUnderReview order by o.id"),
